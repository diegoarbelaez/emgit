        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div id="tracking">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <h5 class="card-title">Generador de Informe por PDF para Contratista</h5>
                            <div>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                            <label></label><br>
                                                <button class="btn btn-success" style="margin-left: 12px; margin-top: 7px;" >Ver Actividades</button>
                                            </div>
                                        </td>
                                </table>
                                </form>
