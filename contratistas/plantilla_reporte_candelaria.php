...
<?php
$fecha_inicial_reporte = $_POST["fecha_inicio"]." 00:00:00";
$fecha_final_reporte = $_POST["fecha_fin"]." 23:59:59";
...
$sentencia_fechas = "insert into fecha_informes_contratista (fk_id_contratista,fecha_inicio,fecha_fin) values ($id_contratista,'$fecha_inicial_reporte','$fecha_final_reporte')";
