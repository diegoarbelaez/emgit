            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    <div>
                        ...
                        <div class="page-title-subheading">Informe presentado para el mes de <?php echo $mes . " del año ". '' . date("Y"); ?>
                        </div>
                    </div>
                </div>
            </div>
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    <div>
                        ...
                        <div class="page-title-subheading">INFORME DE ACTIVIDADES DEL CONTRATISTA
                        </div>
                    </div>
                </div>
            </div>
