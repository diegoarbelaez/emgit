                            ...
                            <div class="tracking-list">
                                ...
                                ?>
                                    <div class="tracking-item">
                                        ...
                                        $fecha1 = date("Y-m-01");
                                        $sentencia2 = "SELECT * from log WHERE fk_id_actividad=$id_actividad and fecha between '$fecha_inicio' and  '$fecha_final' order by id_log desc";
                                        //echo $sentencia2;
                                        ...
                                        ?>
                                            ...
                                            <div class="tracking-content">
                                                ...
                                                <br><?php echo $ruta; ?><a href="calificar_log.php?id_log=<?php echo base64_encode($id_log) ?>&id_contratista=<?php echo base64_encode($id_contratista) ?>" class="btn btn-danger" style="margin-left: 5px">Calificar este Hecho</a><br><br><br>
                                            </div> <?php
                                                }
                                                echo '<br></div>';
                                            }
