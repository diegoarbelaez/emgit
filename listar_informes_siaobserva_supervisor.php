        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Informes de Supervisión Generados
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Listado de Informes de Supervisión</h5>
                        <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                                $dir    = 'contratistas/SIAOBSERVA/SUPERVISORES/';
                                $files1 = scandir($dir);
                                ...
                                foreach ($files1 as $archivo) {
                                    ...
                                    if (strlen($archivo) > 30) {
                                        echo "<tr>";
                                        echo "<td><a href='contratistas/SIAOBSERVA/SUPERVISORES/" . $archivo . "' target='new'>" . $archivo . "</a></td>";
