...
$recupera_informe = "select * from fecha_informes_supervision where id_fecha=$id_fecha ";
$resultado_informe = mysqli_query($conexion,$recupera_informe);
$fila_informe = mysqli_fetch_assoc($resultado_informe);



$fecha_inicio = $fila_informe["fecha_inicio"];
$fecha_fin = $fila_informe["fecha_fin"];
$id_contratista = $fila_informe["fk_id_contratista"];

$numero_cuotas = $fila_informe["numero_cuotas"];
$valor_mensual =  $fila_informe["valor_mensual"];
$cuota_pagada =  $fila_informe["cuota_pagada"];
$ultimo_pago = $fila_informe["fk_id_ultimo_pago"];
$eps =  $fila_informe["eps"];
$pension =  $fila_informe["pension"];
$arl =  $fila_informe["arl"];
$fecha_impresion =  $fila_informe["fecha_impresion"];
...
?>
    ...
    <div>
        <p>
            ...
            de conformidad con el presente contrato, la cantidad de <?php echo $valor_contrato ?>. Pagados en <?php echo $numero_cuotas ?> cuotas mensuales iguales, por valor de $<?php echo number_format($valor_mensual) ?>.
            <br>
            ...
            $sentencia_validar = "SELECT * FROM pagos WHERE fk_id_contrato=$id_contrato and id_pago <= $ultimo_pago";
