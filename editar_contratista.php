            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Editar Información del Contratista
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="info_basica" role="tabpanel">
                                    <form id="registration_form_2" action="actualizar_contratista_inteligente.php" method="POST">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="Cedula" class="">Cedula</label><span style="color:red" id="info_cedula"></span><input name="cedula" id="cedula" min="1" pattern="^[0-9]+" placeholder="Cédula" type="number" class="form-control" value="<?php echo $fila->cedula ?>" required="true"></div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <button id="enviar" class="btn btn-success">GUARDAR INFORMACIÓN DEL CONTRATISTA</button>
                                    </form>
                                </div>
...
//Editar Contratista tipo Persona Jurídica
{
?>
                                ...
                                <div class="tab-pane show active" id="info_basica" role="tabpanel">
                                    <form id="registration_form_2" action="actualizar_contratista_inteligente.php" method="POST">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="Nombres" class="">Dirección</label><input name="direccion_residencia" id="nombres" placeholder="" type="text" class="form-control" value="<?php echo $fila->direccion_residencia ?>" required="true"></div>
                                            </div>
